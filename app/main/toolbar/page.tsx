...
import ShareButton from '../topbar/components/shareButton';
import SyncStatus from '../topbar/components/syncStatus';

const Toolbar = () => {
  const { currentEditor } = useEditorStore();
  return (
    <div className='flex p-2 pl-5 pr-5 border-b-1 border-neutral-800 items-center justify-between'>
